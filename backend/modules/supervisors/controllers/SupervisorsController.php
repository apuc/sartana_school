...
use backend\modules\supervisors\models\SupervisorsSearch;
...
class SupervisorsController extends Controller
{
    ...
    {
        $searchModel = new SupervisorsSearch();
    ...
    /**
     * Updates an existing Supervisors model.
    ...
    {
        if (($model = Supervisors::findOne(['id' => $id])) !== null) {
            return $model;
        }
